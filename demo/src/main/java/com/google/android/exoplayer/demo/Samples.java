...
/* package */ class Samples {
    ...
    public static final Sample[] MISC = new Sample[] {
            new Sample("Redstation+Singapoore", "http://mis5.vocvox.com:8081/fast/first.mp3", Util.TYPE_OTHER),
            new Sample("All from Singapoore", "http://13.76.40.23:8088/full.mp3", Util.TYPE_OTHER),
               new Sample("FAST file", "http://192.168.0.189:8081/fast/first.mp3", Util.TYPE_OTHER),
            new Sample("Other music", "http://192.168.0.189:8081/slow/other.m4a", Util.TYPE_OTHER),
            new Sample("REMOTE file", "http://192.168.0.189:8081/slow/full.mp3", Util.TYPE_OTHER)
